          ...
          <div>
            <div className="card flex-row w-full card-body border-0 p-3 m-2 rounded-0 size-fit mt-20 bg-warning-subtle opacity-100 text-neutral">
              ...
              <div className="flex flex-col w-5/6">
                <a className="text-lg">{quesInfo.question}</a>
                <p>{quesInfo.tags}</p>
                <p className="opacity-50 pl-96">asked {quesInfo.q_time} ago</p>
              </div>
            </div>
          </div>
        ))}
...
{/* <button className="btn btn-outline w-8 border-0  p-0 btn-neutral">
<svg
